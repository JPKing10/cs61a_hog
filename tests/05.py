      ...
      'cases': [
        {
          ...
          >>> s0
          34925130a43323b1fb56610276d844e6
          # locked
          >>> s1
          77ff06fbe493a9a25c9b78e886e0df26
          # locked
          """,
          'hidden': False,
          'locked': True
    ...
    },
    {
      'cases': [
        ...
        },
        {
          ...
          >>> s0, s1 = hog.play(always(1), always(3), goal=30, dice=hog.make_test_dice(5, 6, 6, 4, 4, 5, 5, 6, 3, 4, 3, 2))
          >>> s0
          32
          >>> s1
          21
